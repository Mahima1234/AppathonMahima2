...
final Color path1Color = Color(0xFF2196F3);
final Color getStartedColorStart = Color(0xff54D579);
final Color getStartedColorEnd = Color(0xff00AABF);
// final Color getStartedColorStart = Color(0xffD5E0FA);
// final Color getStartedColorEnd = Color(0xFF2196F3);
final Color path2Color = Color(0xffcef4eb);
